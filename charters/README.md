...
- [`cindervault/`](cindervault/) — divergence one: *the city that banked the last fire* (forge-dark, Zilla Slab, phases: ashdawn / forge-day / smelt-dusk / banked). city scale, 12 regions.
- [`skeinsea/`](skeinsea/) — divergence two: *the archipelago where the fog remembers* (mist-pale, Jost, phases: morning tide / high glass / gloaming / bell-dark). hamlet scale, 3 islets.
